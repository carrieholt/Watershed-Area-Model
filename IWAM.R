...
if(mod=="IWAM_FixedSep_RicStd"|mod=="Liermann"|mod=="Liermann_SepRicA"|mod=="Liermann_HalfNormRicVar"|mod=="Liermann_HalfCauchyRicVar") SRDat_std <- SRDat
...
if(mod=="IWAM_FixedSep_RicStd"|mod=="Liermann"|mod=="Liermann_SepRicA"|mod=="Liermann_HalfNormRicVar"|mod=="Liermann_HalfCauchyRicVar")Stream <- Stream  %>% arrange(Stocknumber)
# 2. Create data and parameter lists for TMB
...
if(mod=="IWAM_FixedSep_RicStd"|mod=="Liermann"|mod=="Liermann_SepRicA"|mod=="Liermann_HalfNormRicVar"|mod=="Liermann_HalfNormRicVar"){
...
if(mod=="Liermann_SepRicA"|mod=="Liermann_HalfNormRicVar"|mod=="Liermann_HalfNormRicVar"){
...
if (mod=="IWAM_FixedSep"|mod=="IWAM_FixedSep_RicStd"|mod=="Liermann"||mod=="Liermann_SepRicA"|mod=="Liermann_HalfNormRicVar"|mod=="Liermann_HalfNormRicVar"){
  ## Lierman model
...
if(mod=="Liermann_SepRicA"|mod=="Liermann_HalfNormRicVar"|mod=="Liermann_HalfCauchyRicVar"|mod=="Liermann_HalfNormRicVar"){
  #upper<-unlist(param)
...
if(plot==TRUE){
  ...
  if (mod=="Liermann_HalfNormRicVar") title_plot <- "Half-normal Ricker variances"
  if (mod=="Liermann_HalfCauchyRicVar") title_plot <- "Half-Cauchy Ricker variances"
