...
8. What is the quasiR2? This is a ratio indicating how close is the fit to being perfect or the worst (not the percentage of variance explained by the logistic model, as in linear models)
```{r warning=FALSE, message=FALSE, error=FALSE}
  #-------------------------------------------------------------------------------
  # Step 8. 
...
```
9. What is the classification accuracy?
```{r warning=FALSE, message=FALSE, error=FALSE}
  #-----------------------------------------------------------------------------
  # Step 9. 
