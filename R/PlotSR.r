...
#   projLRPa <- projLRPin %>% filter(OM=="cvER0.21.cvERSMU0.42.agePpnConst.recCorSca0.n100.mcmc") %>% pull(LRP)
#  projLRPb <- projLRPin %>% filter(OM=="cvER0.42.cvERSMU0.42.agePpnConst.recCorSca0.1.n100.mcmc") %>% pull(LRP)
#  projLRPc <- projLRPin %>% filter(OM=="cvER0.cvERSMU0.42.agePpnConst.recCorSca0.n100.mcmc") %>% pull(LRP)
# projLRPd <- 5700
# projLRPe <- 5900
# projLRPf <- 6100
# projLRPAllp <- data.frame(read.csv("c:/github/SalmonLRP_RetroEval/WCVIChinookStudy/DataOut/ProjectedLRPs/ProjectedLRPscvER0.21Allpv2.csv"))
