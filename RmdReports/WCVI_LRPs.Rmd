...
```{r fig.cap = "**Figure 5**. Time-series of SMU abundances (summation of indicators stocks with average NI >0.5) relative to LRP."}
...
```
```{r fig.cap = "**Figure 10**. Time-series of SMU abundances (summation of all indicators stocks) relative to LRP, with all indicator stocks included."}
# Calculate distribution of overall LRPs by integrating bootstrapped LRP 
# values with uncertainty of each LRP value from TMB
LRP.samples <- rnorm(nBS*10, LRP.bs$fit, (LRP.bs$fit - LRP.bs$lwr) / 1.96)
hist(LRP.samples)
